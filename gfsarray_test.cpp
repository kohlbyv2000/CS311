...
#include "gfsarray.hpp"      // For class template GFSArray
#include "gfsarray.hpp"      // Double-inclusion check, for testing only
...
//  returns false), allowing it to be the value type of a sorted
//  container.
// If static member _copyThrow is set, then copy ctor and copy assn
//  throw std::runtime_error. Exception object's "what" member is set to
//  "C" by the copy ctor and "A" by copy assn.
// Increments static data member _ctorCount on default construction and
//  successful copy construction. Increments static data member
//  _assnCount on successful copy assignment. Increments static data
//  member _dctorCount on destruction.
// Increments static data member _existing on construction, and
//  decrements it on destruction.
// Static data member _maxExisting is highest value of _existing since
//  last reset, or start of program if reset has never been called.
// Invariants:
//     Counter::_existing is number of existing objects of this class.
//     Counter::_ctorCount is number of successful ctor calls since
//      most recent call to reset, or start of program if reset has
//      never been called.
...
private:
    ...
    static size_t _ctorCount;    // # of non-throwing ctor calls
    static size_t _dctorCount;   // # of dctor calls
    static size_t _assnCount;    // # of non-throwing copy = calls
    static bool _copyThrow;      // true if copy ops (ctor, =) throw
...
TEST_CASE( "GFSArray member types" )
{
    SUBCASE( "Member type value_type" )
    {
        {
        GFSArray<int>::value_type x1;
        [[maybe_unused]] int & r(x1);
        INFO( "GFSArray<int>::value_type must be int" );
        REQUIRE( TypeCheck<int>::check(x1) );
        }

        {
        GFSArray<string>::value_type x2;
        [[maybe_unused]] string & r(x2);
        INFO( "GFSArray<string>::value_type must be string" );
    ...
    {
        {
        GFSArray<int>::size_type x1;
        [[maybe_unused]] size_t & r(x1);
        INFO( "GFSArray<int>::size_type must be size_t" );
        REQUIRE( TypeCheck<size_t>::check(x1) );
        }

        {
        GFSArray<string>::size_type x2;
        [[maybe_unused]] size_t & r(x2);
        INFO( "GFSArray<string>::size_type must be size_t" );
    ...
    {
        {
        GFSArray<int>::iterator x1;
        [[maybe_unused]] int * & r(x1);
        INFO( "GFSArray<int>::iterator must be (int *)" );
        REQUIRE( TypeCheck<int *>::check(x1) );
        }

        {
        GFSArray<string>::iterator x2;
        [[maybe_unused]] string * & r(x2);
        INFO( "GFSArray<string>::iterator must be (string *)" );
        REQUIRE( TypeCheck<string *>::check(x2) );
        }
    }
    ...
    {
        {
        GFSArray<int>::const_iterator x1;
        [[maybe_unused]] const int * & r(x1);
        INFO( "GFSArray<int>::const_iterator must be (const int *)" );
        REQUIRE( TypeCheck<const int *>::check(x1) );
        }

        {
        GFSArray<string>::const_iterator x2;
        [[maybe_unused]] const string * & r(x2);
        INFO(
          "GFSArray<string>::const_iterator must be (const int *)" );
...
TEST_CASE( "GFSArray function return types" )
{
    SUBCASE( "Member function copy= - return type" )
    {
        {
        const GFSArray<int> cti;
        GFSArray<int> ti;
        [[maybe_unused]] GFSArray<int> & r(ti = cti);
        INFO( "GFSArray<int> copy= returns GFSArray<int> by ref" );
        REQUIRE( TypeCheck<GFSArray<int>>::check(ti = cti) );
        }

        {
        const GFSArray<string> cts;
        GFSArray<string> ts;
        [[maybe_unused]] GFSArray<string> & r(ts = cts);
        INFO(
          "GFSArray<string> copy= returns GFSArray<string> by ref" );
        REQUIRE( TypeCheck<GFSArray<string>>::check(ts = cts) );
        }
    }
    ...
    SUBCASE( "Member function move= - return type" )
    {
        ...
        GFSArray<int> ti2;
        GFSArray<int> ti3;
        [[maybe_unused]] GFSArray<int> & r(ti1 = std::move(ti2));
        INFO( "GFSArray<int> move= returns GFSArray<int> by ref" );
        REQUIRE( TypeCheck<GFSArray<int>>::check(
                   ti2 = std::move(ti3)) );
        }
        ...
        GFSArray<string> ts2;
        GFSArray<string> ts3;
        [[maybe_unused]] GFSArray<string> & r(ts1 = std::move(ts2));
        INFO(
          "GFSArray<string> move= returns GFSArray<string> by ref" );
        REQUIRE( TypeCheck<GFSArray<string>>::check(
                   ts2 = std::move(ts3)) );
        }
    }
    ...
    {
        {
        const GFSArray<int> cti(10);
        [[maybe_unused]] size_t && r(cti.size());
        INFO( "GFSArray<int> size returns size_t by value" );
        REQUIRE( TypeCheck<size_t>::check(cti.size()) );
        }

        {
        const GFSArray<string> cts(10);
    ...
    SUBCASE( "Member function empty - return type" )
    {
        ...
        INFO( "GFSArray<int> empty returns bool by value" );
        ...
        INFO( "GFSArray<string> empty returns bool by value" );
    ...
    SUBCASE( "Member function bracket op - return type" )
    {
        ...
        INFO( "GFSArray<int> bracket op returns int by ref" );
        REQUIRE( TypeCheck<int>::check(ti[0]) );
        }

        {
        GFSArray<string> ts(10);
        [[maybe_unused]] string & r(ts[0]);
        INFO( "GFSArray<string> bracket op returns string by ref" );
        ...
        INFO(
          "const GFSArray<int> bracket op returns const int by ref" );
        ...
        INFO( "const GFSArray<string> bracket op"
                " returns const string by ref" );
    ...
    SUBCASE( "Member function begin - return type" )
    {
        ...
        INFO( "GFSArray<int> begin returns (int *) by value" );
        ...
        INFO( "GFSArray<string> begin returns (string *) by value" );
        ...
        INFO(
          "const GFSArray<int> begin returns (const int *) by value" );
        ...
        INFO( "const GFSArray<string> begin"
                " returns (const string *) by value" );
    ...
    SUBCASE( "Member function end - return type" )
    {
        ...
        INFO( "GFSArray<int> end returns (int *) by value" );
        ...
        INFO( "GFSArray<string> end returns (string *) by value" );
        ...
        INFO(
          "const GFSArray<int> end returns (const int *) by value" );
        ...
        INFO( "const GFSArray<string> end"
                " returns (const string *) by value" );
    ...
    SUBCASE( "Member function insert - return type" )
    {
        ...
        INFO( "GFSArray<int> insert returns (int *) by value" );
        ...
        INFO( "GFSArray<string> insert returns (string *) by value" );
        REQUIRE( TypeCheck<string *>::check(
                   ts.insert(ts.begin(), string())) );
        }
    }
    ...
    SUBCASE( "Member function erase - return type" )
    {
        ...
        INFO( "GFSArray<int> erase returns (int *) by value" );
        ...
        INFO( "GFSArray<string> erase returns (string *) by value" );
...
TEST_CASE( "GFSArray noexcept" )
{
    GFSArray<Counter> tc1;
    GFSArray<Counter> tc2;

    SUBCASE( "noexcept - move ctor" )
    {
        INFO( "Move ctor must be noexcept" );
        REQUIRE( noexcept(GFSArray<Counter>(std::move(tc1))) );
    }
    ...
    SUBCASE( "NOT noexcept - copy ctor" )
    {
        ...
        REQUIRE_FALSE( noexcept(GFSArray<Counter>(tc1)) );
    }

    SUBCASE( "NOT noexcept - ctor from size" )
    {
        INFO( "Ctor from size must NOT be noexcept" );
        REQUIRE_FALSE( noexcept(GFSArray<Counter>(100)) );
    }
...
TEST_CASE( "GFSArray default ctor, size, empty" )
{
    SUBCASE( "Default ctor" )
    {
        const GFSArray<int> cti;
        {
        INFO( "Default constructed GFSArray has size 0" );
        REQUIRE( cti.size() == size_t(0) );
        }
        {
        INFO( "Default constructed GFSArray is empty" );
        REQUIRE( cti.empty() );
        }
        {
        INFO( "Default constructed GFSArray: begin == end" );
...
TEST_CASE( "GFSArray ctor from size, size, empty, begin, end" )
{
    SUBCASE( "Ctor from size - size 0" )
    {
        const size_t SIZE = size_t(0);
        const GFSArray<int> cti(SIZE);
        {
        INFO( "GFSArray constructed with size " << SIZE << ": size" );
        REQUIRE( cti.size() == SIZE );
        }
        {
        INFO( "GFSArray constructed with size "
                << SIZE << " is empty" );
        REQUIRE( cti.empty() );
        }
        {
    ...
    SUBCASE( "Ctor from size - small size" )
    {
        ...
        {
        INFO( "GFSArray constructed with size " << SIZE << ": begin" );
        REQUIRE( cti.begin() == &cti[0] );
        }
        {
        INFO( "GFSArray constructed with size " << SIZE << ": end" );
...
TEST_CASE( "GFSArray bracket operator" )
{
    SUBCASE( "Bracket op" )
    {
        const size_t SIZE = size_t(10);
        GFSArray<int> ti(SIZE);
        ...
        ti[2] = 1000;
        {
        INFO( "Bracket op (non-const)"
                " - check values after changing a value" );
        for (size_t i = 0; i < SIZE; ++i)
        {
            REQUIRE(
              ti[i] == (i == size_t(2) ? 1000 : 15-int(i)*int(i)) );
        }
        }

        // Make const version, no copy
        const GFSArray<int> & ctiref = ti;
        {
        INFO( "Bracket op (const) - check values" );
        for (size_t i = 0; i < SIZE; ++i)
        {
            REQUIRE(
              ctiref[i] == (i == size_t(2) ? 1000 : 15-int(i)*int(i)) );
        }
        }
    }
}
...
TEST_CASE( "GFSArray copy ctor" )
{
    SUBCASE( "Copy ctor - separate arrays" )
    {
        ...
        {
            REQUIRE(
              ticopy[i] == (i == size_t(3) ? 2000 : 15-int(i)*int(i)) );
        }
        }
    ...
    {
        const size_t SIZE = size_t(10);
        GFSArray<int> * tip = new GFSArray<int>(SIZE);
        for (size_t i = 0; i < SIZE; ++i)
        {
...
TEST_CASE( "GFSArray copy assignment operator" )
{
...
TEST_CASE( "GFSArray move ctor" )
{
    SUBCASE( "Move ctor - destroy original" )
    {
        ...
        GFSArray<int> timove(std::move(*tip));
...
TEST_CASE( "GFSArray move assignment operator" )
{
...
TEST_CASE( "GFSArray insert" )
{
    const size_t SIZE = size_t(10);
    GFSArray<int> ti_original(SIZE);
    for (size_t i = 0; i < SIZE; ++i)
    {
    ...
    SUBCASE( "Multiple insert-at-end calls" )
    {
        ...
        for (size_t i = SIZE+1; i <= SIZE2; ++i)
        {
            ...
            if (reallocdone)
            {
                ...
                if (realloclast)
                    realloctwice = true;
                {
                INFO( "Many inserts - check return value"
                        " on reallocate-and-copy" );
        ...
        {
        INFO(
          "Many inserts - reallocate-and-copy never done 2x in a row" );
        REQUIRE_FALSE( realloctwice );
        }
        {
...
TEST_CASE( "GFSArray push_back" )
{
    ...
    SUBCASE( "Multiple push_back calls" )
    {
        ...
        {
        INFO(
          "Many push_back calls - how many reallocate-and-copy ops" );
        REQUIRE( realloccount >= 3 );
        REQUIRE( realloccount <= 50 );
        }
        {
        INFO( "Many push_back calls"
                " - never reallocate-and-copy 2x in a row" );
        REQUIRE_FALSE( realloctwice );
        }
        {
...
TEST_CASE( "GFSArray push_back & pop_back" )
{
...
TEST_CASE( "GFSArray swap" )
{
    SUBCASE( "swap" )
    {
        const size_t SIZE1 = size_t(10);
        const size_t SIZE2 = size_t(1000);
        GFSArray<int> ti1(SIZE1);
        for (size_t i = 0; i < SIZE1; ++i)
        {
            ti1[i] = int(i)*int(i);
        }
        GFSArray<int> ti2(SIZE2);
        for (size_t i = 0; i < SIZE2; ++i)
        {
            ti2[i] = 100-int(i);
        }
...
TEST_CASE( "GFSArray ctor/dctor count" )
{
    SUBCASE( "Ctor/dctor calls on construction by size, destruction" )
    {
        ...
        size_t objectcount;  // Ctor calls - dctor calls
        {
            ...
            const GFSArray<Counter> tc(SIZE);
            ctorcount = Counter::getCtorCount();
            dctorcount = Counter::getDctorCount();
            {
            INFO( "Number of ctor calls for container creation"
                    " is about size" );
            ...
            {
            INFO(
              "Number of dctor calls for container creation is small" );
        ...
        {
        INFO( "No value-type objects constructed"
                " on container destruction" );
        REQUIRE( ctorcount == 0 );
        }
        {
        INFO(
          "All value-type objects destroyed on container destruction" );
    ...
    SUBCASE( "Ctor/dctor calls on default construction, destruction" )
    {
        ...
        size_t objectcount;  // Ctor calls - dctor calls
        {
            ...
            {
            INFO( "Number of dctor calls for container creation"
                    " is small" );
            REQUIRE( dctorcount <= ctorcount );
            REQUIRE( dctorcount <= 2 );
            }
        ...
        {
        INFO( "All value-type objects destroyed"
                " on container destruction" );
        REQUIRE( dctorcount == objectcount );
        }
    }
    ...
    SUBCASE( "Ctor/dctor calls on move construction, destruction" )
    {
        ...
        {
            GFSArray<Counter> tc;
            const GFSArray<Counter> tc2(std::move(tc));
...
TEST_CASE( "GFSArray exceptions" )
{
    ...
    SUBCASE( "Exceptions - copy ctor" )
    {
        Counter::reset(true);
        {
            const GFSArray<Counter> tc(10);

            try
            {
                GFSArray<Counter> tc2(tc);
    ...
    SUBCASE( "Exceptions - move ctor" )
    {
        Counter::reset(true);  // Copy operations throw
        {
            ...
            try
            {
                GFSArray<Counter> tc2(std::move(tc));
                throws = false;
            }
            catch (...)
            {
    ...
    SUBCASE( "Exceptions - swap" )
    {
        Counter::reset(true);
        {
            GFSArray<Counter> tc1(10);
            GFSArray<Counter> tc2(1000);
